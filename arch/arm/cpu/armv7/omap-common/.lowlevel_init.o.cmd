cmd_arch/arm/cpu/armv7/omap-common/lowlevel_init.o := arm-linux-gnueabihf-gcc -Wp,-MD,arch/arm/cpu/armv7/omap-common/.lowlevel_init.o.d  -nostdinc -isystem /usr/MyWork/Toolchain/gcc-linaro-5.3-2016.02-x86_64_arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/5.3.1/include -Iinclude    -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -D__ASSEMBLY__ -g -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mword-relocations -fno-pic -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a   -c -o arch/arm/cpu/armv7/omap-common/lowlevel_init.o arch/arm/cpu/armv7/omap-common/lowlevel_init.S

source_arch/arm/cpu/armv7/omap-common/lowlevel_init.o := arch/arm/cpu/armv7/omap-common/lowlevel_init.S

deps_arch/arm/cpu/armv7/omap-common/lowlevel_init.o := \
...
arch/arm/cpu/armv7/omap-common/lowlevel_init.o: $(deps_arch/arm/cpu/armv7/omap-common/lowlevel_init.o)
