cmd_spl/arch/arm/cpu/armv7/omap-common/reset.o := arm-linux-gnueabihf-gcc -Wp,-MD,spl/arch/arm/cpu/armv7/omap-common/.reset.o.d  -nostdinc -isystem /usr/MyWork/Toolchain/gcc-linaro-5.3-2016.02-x86_64_arm-linux-gnueabihf/bin/../lib/gcc/arm-linux-gnueabihf/5.3.1/include -Iinclude    -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -ffunction-sections -fdata-sections -D__ARM__ -Wa,-mimplicit-it=always -mthumb -mthumb-interwork -mabi=aapcs-linux -mno-unaligned-access -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(reset)"  -D"KBUILD_MODNAME=KBUILD_STR(reset)" -c -o spl/arch/arm/cpu/armv7/omap-common/reset.o arch/arm/cpu/armv7/omap-common/reset.c

source_spl/arch/arm/cpu/armv7/omap-common/reset.o := arch/arm/cpu/armv7/omap-common/reset.c

deps_spl/arch/arm/cpu/armv7/omap-common/reset.o := \
  include/config.h \
...
spl/arch/arm/cpu/armv7/omap-common/reset.o: $(deps_spl/arch/arm/cpu/armv7/omap-common/reset.o)
